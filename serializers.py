...
# This serializer is used for the gallery view, which includes images and their metadata
# We remove unnecessary fields to optimize the response
# By default depth should be 0 and we can increase it if needed
# Avoid using  unnecessary depth to reduce response size
...
class GallerySerializerExcludeCoordinates(DynamicDepthSerializer):
    ...
    rock_carving_object = RockCarvingSerializer(many=True)
